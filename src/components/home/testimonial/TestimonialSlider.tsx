...
function CustomSlider({ children, settings = {} }: CustomSliderProps) {
  ...
  return (
    <div className="relative">
      ...
      {mergedSettings.dots && children.length > 1 && (
...
export default function TestimonialSlider({
  ...
  const settings: SliderSettings = {
    ...
    slidesToShow: 1,
    slidesToScroll: 1,
    arrows: sWidth > 600 && testimonials.length > 1,
    nextArrow: <NextArrow />,
    prevArrow: <PrevArrow />,
  };
      ...
      <CustomSlider settings={settings}>
        {testimonials.map((testimonial) => (
          <div className="w-full my-12 h-full relative" key={testimonial._id}>
            <article className="p-[30px] max-w-4xl mx-auto text-center rounded-[10px] bg-white hover:shadow-lg duration-500 flex flex-col gap-y-3">
              <div className="p-4 lg:text-[15px] md:text-[13px] text-[11px]">
                <div className="flex justify-end mb-4">
                  <svg
                    className="w-[50px] h-[50px] opacity-20"
                    version="1.0"
                ...
                <span className="block text-mainPurple mb-2">
                ...
                <p className="text-textGray mx-auto max-w-[85ch] text-base leading-relaxed">
