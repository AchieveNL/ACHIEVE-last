...
const Footer = () => {
  return (
    <footer
      className="FOOTER bg-achieve-purple"
      style={{
        backgroundImage: `url("https://res.cloudinary.com/tretrak/image/upload/v1651468026/achieve/bg10_qtoqh2.png")`,
        ...
        <div className="container mx-auto px-4 flex flex-col">
          <div className="flex flex-col">
            ...
            <div className="800:!flex-col 800:gap-y-12 flex justify-between border-b-[1px] border-[#e1e1f0] mb-[30px] pb-[10px] flex-wrap ml-[-15px] mr-[-15px] items-center">
              {/* Logo */}
              <div className="basis-1/3 flex justify-start pl-6 items-center 800:justify-center 800:pl-0">
                <a className="inline-block w-[50%] 1000:!w-[70%]" href="/">
                  <img
                    className="w-full"
              ...
              {/* Address */}
              <div className="flex justify-end basis-1/3 gap-x-4 items-center pr-5 1000:pr-0">
                <div className="flex justify-center items-center">
                  <a
                    className="flex justify-center items-center"
                    href="/contact"
            ...
            <div className="flex justify-between 800:flex-col">
                    ...
                    <ul className="flex gap-x-2">
                      <li>
                        <a
                          ...
                          className="group hover:bg-achieve-purple cursor-pointer inline-flex justify-center items-center size-[32px] leading-[32px] text-center rounded-full text-[14px] bg-white duration-500 m-[2px]"
                          target="_blank"
                        ...
                        >
                          <svg
                            ...
                            strokeWidth="0"
                            viewBox="0 0 512 512"
                            className="group-hover:text-white text-mainPurple text-[14px] text-center leading-[32px]"
                            height="1em"
                            width="1em"
                      ...
                      <li>
                        <a
                          ...
                          className="group hover:bg-mainPurple cursor-pointer inline-flex justify-center items-center size-[32px] leading-[32px] text-center rounded-full text-[14px] bg-white duration-500 m-[2px]"
                          target="_blank"
                          rel="noopener noreferrer"
                        >
                          <svg
                      ...
                      <li>
                        ...
                        >
                          <svg
                            ...
                            strokeWidth="0"
                            viewBox="0 0 448 512"
                            className="group-hover:text-white text-achieve-purple text-[14px] text-center leading-[32px]"
                            height="1em"
                            width="1em"
                            xmlns="http://www.w3.org/2000/svg"
                          >
              ...
              <div className="flex justify-between basis-[80%] 600:flex-col">
                ...
                <div className="basis-1/3 flex justify-center">
                  <div className="mb-[30px] 600:text-center">
                    <div className="flex flex-col gap-y-1 mb-[30px]">
                      <h5 className="text-[24px] font-bold pb-[10px] text-white leading-[1.2]">
                        Menu
                      </h5>
                      <div className="flex items-center gap-x-1 600:justify-center">
                    ...
                    <div>
                      <ul>
                        <li>
                          <a
                            className="text-white duration-500 py-[5px] inline-block hover:translate-x-[15px]"
                            href="/"
                          >
                            Home
                          </a>
