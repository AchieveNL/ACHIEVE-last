...
const VideoMarketingSection = () => {
  const { t, locale } = useClientTranslations("page-ugc-marketing.heroSection");

  const benefits = [
    "ugc-authenticity",
    "increased-involvement",
    "trust-credibility",
    "expenential-visibility",
    "content-keep-working",
  ];

  return (
    <div className="py-24 relative z-10 lg:py-32 px-4 md:px-6 lg:px-0">
        ...
        <div className="grid lg:grid-cols-2 grid-cols-1 gap-8 lg:gap-12 items-center">
          ...
          <div className="relative w-full h-[300px] md:h-[420px] lg:h-[558px] flex items-center justify-center order-first lg:order-last">
            <div className="relative w-full h-full max-w-[591.5px]">
              <Image
                src="/diesten/ugc-marketing/ugc-marketing-hero.png"
                fill
                alt="Video Marketing Hero"
