...
const ServicesDiscount = () => {
  const { t, locale } = useClientTranslations(
    "page-ugc-marketing.discountSection",
  );
  ...
  return (
    <section
      className=" py-12 bg-achieve-background md:py-20 lg:py-24 px-4 md:px-6"
      style={{
      ...
      <div className="container mx-auto text-center">
        <div className="flex flex-col gap-6 md:gap-8">
          ...
          <p className="text-achieve-navy text-sm md:text-base max-w-2xl mx-auto px-2">
            {t("firstdescriptionPart")}{" "}
            {currentMonth && <span className="capitalize">{currentMonth}</span>}{" "}
            {t("seconddescriptionPart")}
          </p>
